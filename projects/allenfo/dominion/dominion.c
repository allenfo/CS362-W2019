...
int mineTest(int j, struct gameState *state, int choice1, int choice2, int choice3, int currentPlayer, int handPos)
{
...
int remodelTest(int j, struct gameState *state, int currentPlayer, int choice1, int choice2, int choice3, int handPos)
{
      j = state->hand[currentPlayer][choice1];  //store card we will trash
...
*/			
    ...
    case mine:
 mineTest(j, state,  choice1, choice2, choice3, currentPlayer, handPos);
 /*    j = state->hand[currentPlayer][choice1];  //store card we will trash
      if (state->hand[currentPlayer][choice1] < copper || state->hand[currentPlayer][choice1] > gold)
	{
	  return -1;
...
*/			
    ...
    case remodel:
remodelTest(j, state, currentPlayer,  choice1, choice2, choice3, handPos);
 /*    j = state->hand[currentPlayer][choice1];  //store card we will trash
      if ( (getCost(state->hand[currentPlayer][choice1]) + 2) > getCost(choice2) )
	{
	  return -1;
